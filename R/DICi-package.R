...
#'
#' Computes \eqn{\mathrm{DIC}_i}{DIC_i}, a parameterization-invariant, plug-in-free version of the
#' Deviance Information Criterion for Bayesian model comparison in latent
#' variable models (Xiao and Rabe-Hesketh, 2026).
#'
#' @section Main functions:
#' \describe{
#'   \item{[compute_dic_i()]}{Compute \eqn{\mathrm{DIC}_i}{DIC_i} from a log-likelihood matrix
#'     or deviance draws.}
#'   \item{[dic_i_from_cmdstanr()]}{Convenience wrapper for CmdStanR fit
#'     objects.}
#'   \item{[compare_dic_i()]}{Compare \eqn{\mathrm{DIC}_i}{DIC_i} across multiple models.}
