# Stan Workflow: Factor Analysis with Sign Switching
...
The key design choice is using the **marginal** likelihood. For a
one-factor model, this means integrating out the latent factor
analytically:

\\\mathbf{y}\_j \mid \boldsymbol{\theta} \sim
\mathcal{N}\_P(\boldsymbol{\alpha},\\
...
The `generated quantities` block outputs pointwise marginal
log-likelihoods, which is what
...
For models estimated in **JAGS** or **Mplus**, see
[`?compute_dic_i`](https://doriaxiao.github.io/DIC_i/reference/compute_dic_i.md).

## References

- Xiao, X. and Rabe-Hesketh, S. (2026). A Parameterization-Invariant
  DIC. *arXiv preprint* arXiv:2605.27844.
...
- Merkle, E.C., Furr, D., and Rabe-Hesketh, S. (2019). Bayesian
